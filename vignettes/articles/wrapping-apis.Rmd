...
```{r, include = FALSE}
#| eval: true
# If we have no base pipe available, the faker call will not work anyway, 
# so set faker_ok directly to FALSE
faker_ok <- ifelse(has_pipe, TRUE, FALSE)
```
